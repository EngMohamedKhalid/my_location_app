...
import '../../features/auth_feature/data/repo_imp/auth_repo_impl.dart';
import '../../features/auth_feature/domain/repo/auth_repo.dart';
import '../../features/auth_feature/domain/usecases/submit_phone_use_case.dart';
...
//
// void _authUseCases() {
//    getIt.registerLazySingleton<SubmitPhoneUseCase>(() => SubmitPhoneUseCase(repository: getIt()));
